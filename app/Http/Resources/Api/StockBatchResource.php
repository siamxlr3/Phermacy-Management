...
class StockBatchResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'qty_tablets_remaining' => (int) $this->qty_tablets_remaining,
            'qty_boxes' => (int) $this->qty_boxes,
            'qty_boxes_remaining' => (int) $this->qty_boxes_remaining,
            'qty_units' => $this->qty_units ? (int) $this->qty_units : null,
            'qty_units_remaining' => $this->qty_units_remaining ? (int) $this->qty_units_remaining : null,
