...
import { Search, Plus, Clock, User, Calendar, Trash2, Edit2, CheckCircle2, XCircle, AlertCircle, Clock3, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="shrink-0 flex items-center justify-between px-6 py-4 bg-slate-50/30 border-t border-slate-100">
        ...
        <div className="flex items-center gap-3">
          <span className="text-[11px] font-bold text-slate-500 px-3 py-1.5 bg-white rounded-xl border border-slate-200 shadow-sm">
            PAGE <span className="text-indigo-600 font-black">{meta.current_page || 1}</span> OF <span className="text-indigo-600 font-black">{meta.last_page || 1}</span>
          </span>
          <div className="flex items-center gap-1.5">
            <button
              onClick={() => setPage(page - 1)}
              disabled={page === 1}
              className="p-2 ml-2 rounded-xl border border-slate-200 hover:bg-white text-slate-400 hover:text-indigo-600 disabled:opacity-30 disabled:cursor-not-allowed transition-all shadow-sm active:scale-95"
            >
              <ChevronLeft size={16} />
            </button>
            <button
              ...
              className="p-2 rounded-xl border border-slate-200 hover:bg-white text-slate-400 hover:text-indigo-600 disabled:opacity-30 disabled:cursor-not-allowed transition-all shadow-sm active:scale-95"
            >
