...
import { Edit2, Search, Trash2, Calendar, Filter, ChevronLeft, ChevronRight, Receipt, User, Phone, MapPin } from 'lucide-react';
                ...
                <div className="flex flex-wrap items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-lg border border-slate-200">
                        ...
                        <select
                            ...
                            className="bg-transparent border-none text-[11px] font-bold text-slate-600 outline-none appearance-none pr-4"
                        >
                    ...
                    <tbody className="divide-y divide-slate-100">
                        {isLoading ? (
                            ...
                            expenses.map((expense) => (
                                <tr key={expense.id} className="group hover:bg-slate-50/50 transition-all duration-150">
                                            ...
                                            {confirmDeleteId === expense.id ? (
                                                <div className="flex items-center gap-1 bg-rose-50 p-1 rounded-lg border border-rose-100">
                                                    <button
                                                        ...
                                                        disabled={isDeleting}
                                                        className="px-2 py-1 bg-red-600 text-white text-[10px] font-black uppercase rounded-md hover:bg-red-700 transition-all"
                                                    >
                                                        Yes
                                                    </button>
                                                    <button
                                                        onClick={() => setConfirmDeleteId(null)}
                                                        className="px-2 py-1 bg-white text-slate-500 text-[10px] font-black uppercase rounded-md border border-slate-200 hover:bg-slate-50 transition-all font-outfit"
                                                    >
                                                        No
                                                    </button>
                                                </div>
                                                ...
                                                <button
                                                    ...
                                                    className="p-1.5 text-slate-300 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors shadow-sm"
                                                    title="Delete"
                                                >
                                                    <Trash2 size={15} />
                                                </button>
